...
def test_update_status_local_only():
...
def test_update_status_check_reports_newer(monkeypatch):
    monkeypatch.setattr(
...
def test_update_status_check_handles_no_releases(monkeypatch):
    monkeypatch.setattr(
...
def test_update_apply_conflicts_when_up_to_date(monkeypatch):
    monkeypatch.setattr(
        "paperless_agent.updater._fetch_latest_release",
        lambda: {
...
def test_update_restart_endpoint_schedules(monkeypatch):
