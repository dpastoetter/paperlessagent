"""Active LLM provider that dispatches to backends in deepcatalog.llm."""
...
class ActiveLlmProvider:
    ...
    ``deepcatalog.llm`` (ADK model factory + per-backend completions).
    """
    ...
    async def complete_text(
        ...
        *,
        ...
        # Late import: deepcatalog.llm imports get_llm_provider for its public API.
        from deepcatalog import llm as llm_mod
    ...
    def health(self) -> dict[str, Any]:
        ...
        from deepcatalog.ollama_setup import ollama_status
